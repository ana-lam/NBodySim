...
"""
def calculate_grav_energies(vec, masses, dimensionless=False):
...
"""Calculate total energy, kinetic energy, & potential energy.
vec: pos and vel
charges: array of N charges
dimensionless: set k=1 or k=8.9875e9
"""
def calculate_elec_energies(vec, masses, charges, dimensionless=False):

    num_bodies = len(charges)
...
body_position: pos of body i
charge: charge of body i
dimensionless: k=1 or k=8.9875e9
softening: softening parameter to avoid blow up when r->0
"""
def compute_elec_potential_energy(body_position, charge, position, dimensionless=False, softening=1e-3):
